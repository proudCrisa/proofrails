...
| 集成 | 用途 | 没有它 |
|---|---|---|
| [OpenSpec](https://github.com/anthropics/openspec) | 规范生命周期 CLI | 回退到 `.proofrails/changes/` |
...
**ProofRails 只有一个必需依赖：git。** 可选集成包括 OpenSpec、gstack、Superpowers 风格工具、GitNexus 和 gbrain；安装有帮助的工具，跳过不需要的工具。
