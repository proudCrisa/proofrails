...
Bug 修复、重构、性能优化、迁移、遗留系统现代化。Harness 强制要求：
...
| Superpowers | TDD 和执行纪律 | Harness 中模拟的规则 |
...
证据是 harness 对"信任但要验证"的回答。每个验证门禁产出或引用证据：
